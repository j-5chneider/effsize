---
title: "Reproducible_Report_Study_II"
format: 
  html:
    fontsize: 0.85em
    toc: true
...
study2_data_detailed <-
    as.data.frame(
        jsonlite::fromJSON(here::here("data/teachers_study2_update01_detailed.json"))) |> 
...
data_w <- full_join(plot_info, 
    ...
    mutate(rating_am = as.numeric(acccl), # some var need to be defined as
           ...
           # actual difference of rating relative to depicted effectsize
           diff_u3 = (1 - rating_u3/100) - effsize_u3,
           #  for no bimodality
           diff_u3_sym = ((1 - rating_u3/100) - .5) - (effsize_u3 - .5),
           # actual difference of rating relative to depicted effectsize 
...
study2_data_ended |> 
    ...
    pivot_longer(cols = c(umean_1x, umean_2x, umean_1y, umean_2y, 
                 ...
                 values_to = "answer") |> 
    ggplot(aes(fill = factor(answer), x = attention_check)) +
...
## Hypothesis H1a: Effects of benchmarks on accuracy (bias & noise)
### Abstract metric
```{r}
...
# fit student varying intercept model sigmavinterceptonly
hyp1a_am_vintercept_student_sigmavinterceptonly <- 
    brm(bf(
        diff_am ~ type + effsize_f + gr_benchmark + (1|session),
        sigma ~  type + effsize_f + (1|session)),
        iter = 40000, warmup = 4000,
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all=TRUE))

plot(hyp1a_am_vintercept_student_sigmavinterceptonly)
pp_check(hyp1a_am_vintercept_student_sigmavinterceptonly) + xlim(c(-1, 1))
conditional_effects(hyp1a_am_vintercept_student_sigmavinterceptonly)

# fit student varying intercept model sigmavintercept
hyp1a_am_vintercept_student_sigmavintercept <- 
    brm(bf(
        diff_am ~ type + effsize_f + gr_benchmark + (1|session),
        sigma ~ gr_benchmark + (1|session)),
        iter = 10000, warmup = 1000,
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
...
plot(hyp1a_am_vintercept_student_sigmavintercept)
pp_check(hyp1a_am_vintercept_student_sigmavintercept) + xlim(c(-1, 1))
conditional_effects(hyp1a_am_vintercept_student_sigmavintercept)
...
modelsummary(
    list("hyp1a_am_vinterceptonly_gaussian" = hyp1a_am_vinterceptonly_gaussian,
         ...
         "hyp1a_am_vintercept_student_sigmavinterceptonly" = hyp1a_am_vintercept_student_sigmavinterceptonly,
         "hyp1a_am_vintercept_student_sigmavintercept" = hyp1a_am_vintercept_student_sigmavintercept),
...
hyp1a_am_noise_bf <- 
  bayes_factor(hyp1a_am_vintercept_student_sigmavintercept,
               hyp1a_am_vintercept_student_sigmavinterceptonly)
hyp1a_am_noise_bf
```

:::{.callout-warning collapse=false appearance='default' icon=true}
- I filtered out just the CG and the benchmark group
:::

### Overlap
```{r}
#| label: hypothesis 1a ov
#| cache: true
data_w |> 
  ggplot(aes(diff_ov, group)) +
    ...
    labs(title = "Accuracy (Overlap)",
         subtitle = "Per Benchmarking and Overlap Misconcept")
```
...
hyp1a_ov_vinterceptonly_student <- 
    brm(diff_ov_filtered ~ type + effsize_f + (1|session),
        iter = 10000, warmup = 1000,
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
...
hyp1a_ov_vintercept_student <- 
    brm(diff_ov_filtered ~ type + effsize_f + gr_benchmark + (1|session),
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all=TRUE))
...
# fit student varying intercept sigmavinterceptonly
hyp1a_ov_vintercept_student_sigmavinterceptonly <- 
    brm(bf(diff_ov_filtered ~ type + effsize_f + gr_benchmark + (1|session),
           sigma ~ + (1|session)),
        iter = 10000, warmup = 1000,
        family = student(), 
        data = data_w |> 
...
plot(hyp1a_ov_vintercept_student_sigmavinterceptonly)
pp_check(hyp1a_ov_vintercept_student_sigmavinterceptonly) + xlim(c(-1, 1))
conditional_effects(hyp1a_ov_vintercept_student_sigmavinterceptonly)

# fit student varying intercept sigmavintercept
hyp1a_ov_vintercept_student_sigmavintercept <- 
    brm(bf(diff_ov_filtered ~ type + effsize_f + gr_benchmark + (1|session),
           sigma ~ type + effsize_f + gr_benchmark + (1|session)),
        iter = 10000, warmup = 1000,
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
...
plot(hyp1a_ov_vintercept_student_sigmavintercept)
pp_check(hyp1a_ov_vintercept_student_sigmavintercept) + xlim(c(-1, 1))
conditional_effects(hyp1a_ov_vintercept_student_sigmavintercept)
...
modelsummary(
    list("hyp1a_ov_vinterceptonly_student" = hyp1a_ov_vinterceptonly_student,
         ...
         "hyp1a_ov_vintercept_student_sigmavinterceptonly" = hyp1a_ov_vintercept_student_sigmavinterceptonly,
         "hyp1a_ov_vintercept_student_sigmavintercept" = hyp1a_ov_vintercept_student_sigmavintercept),
    estimate = "{estimate} [{conf.low}, {conf.high}]"
    )
...
hyp1a_ov_noise_bf <- 
  bayes_factor(hyp1a_ov_vintercept_student_sigmavintercept,
               hyp1a_ov_vintercept_student_sigmavinterceptonly)
hyp1a_ov_noise_bf
```
...
```{r}
#| label: hypothesis 1a u3
data_w |> 
  ggplot(aes(diff_u3_sym, group)) +
    geom_violin() +
    geom_sina(alpha = .05) +
    facet_wrap(~ rating_u3_misconcept) +
    stat_summary(fun.data = mean_sdl, 
...
hyp1a_u3_vinterceptonly_student <- 
    brm(diff_u3_filtered ~ type + effsize_f + (1|session),
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all=TRUE))
...
hyp1a_u3_vintercept_student <- 
    brm(diff_u3_filtered ~ type + effsize_f + gr_benchmark + (1|session),
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all=TRUE))
...
# fit student varying intercept sigmainterceptonly
hyp1a_u3_vintercept_student_sigmainterceptonly <- 
    brm(bf(diff_u3_filtered ~ type + effsize_f + gr_benchmark + (1|session),
           sigma ~ + (1|session)),
        family = student(), 
        data = data_w |> 
            filter(group %in% c("cg", "eg_benchmark")),
...
plot(hyp1a_u3_vintercept_student_sigmainterceptonly)
pp_check(hyp1a_u3_vintercept_student_sigmainterceptonly) + xlim(c(-1, 1))
conditional_effects(hyp1a_u3_vintercept_student_sigmainterceptonly)


# fit student varying intercept sigmaintercept
hyp1a_u3_vintercept_student_sigmaintercept <- 
    brm(bf(diff_u3_filtered ~ type + effsize_f + gr_benchmark + (1|session),
           sigma ~ gr_benchmark + (1|session)),
        family = student(), 
        data = data_w |> 
...
plot(hyp1a_u3_vintercept_student_sigmaintercept)
pp_check(hyp1a_u3_vintercept_student_sigmaintercept) + xlim(c(-1, 1))
conditional_effects(hyp1a_u3_vintercept_student_sigmaintercept)
...
modelsummary(
    list("hyp1a_u3_vinterceptonly_student" = hyp1a_u3_vinterceptonly_student,
         ...
         "hyp1a_u3_vintercept_student_sigmainterceptonly" = hyp1a_u3_vintercept_student_sigmainterceptonly,
         "hyp1a_u3_vintercept_student_sigmaintercept" = hyp1a_u3_vintercept_student_sigmaintercept),
    estimate = "{estimate} [{conf.low}, {conf.high}]"
    )
...
hyp1a_u3_noise_bf <- 
    bayes_factor(hyp1a_u3_vintercept_student_sigmaintercept,
                 hyp1a_u3_vintercept_student_sigmainterceptonly)
hyp1a_u3_noise_bf
```
...
hyp3a_vinterceptonly <-
    brm(diffi ~ type + effsize_f + (1 | session),
        data = data_w |>
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all = TRUE)
    )
...
hyp3a_vintercept <-
    brm(diffi ~ type + effsize_f + gr_benchmark + (1 | session),
        data = data_w |>
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all = TRUE)
    )
...
## Hypothesis H4a: Effects of signaling on efficiency - first plot
```{r}
#| label: hypothesis H4a Effects of signaling on efficiency
#| cache: true
...
## Hypothesis H4a: Effects of signaling on efficiency - last three plots
```{r}
#| label: hypothesis H4a Effects of signaling on efficiency last three
#| cache: true
...
hyp5a_vinterceptonly <-
    brm(infor ~ type + effsize_f + (1 | session),
        iter = 10000,
        data = data_w |>
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all = TRUE)
...
hyp5a_vintercept <-
    brm(infor ~ type + effsize_f + gr_benchmark + (1 | session),
        iter = 10000,
        data = data_w |>
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all = TRUE)
...
hyp6a_vinterceptonly <-
    brm(value ~ type + effsize_f + (1 | session),
        iter = 10000,
        data = data_w |>
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all = TRUE)
...
hyp6a_vintercept <-
    brm(value ~ type + effsize_f + gr_benchmark + (1 | session),
        iter = 10000,
        data = data_w |>
            filter(group %in% c("cg", "eg_benchmark")),
        save_pars = save_pars(all = TRUE)
...
# fit student varying intercept model sigmavinterceptonly
hyp1b_am_vintercept_student_sigmavinterceptonly <- 
    brm(bf(
        diff_am ~ type + effsize_f + group + (1|session),
        sigma ~  + (1|session)),
        iter = 10000, warmup = 1000,
        family = student(), 
        data = data_w |> 
...
plot(hyp1b_am_vintercept_student_sigmavinterceptonly)
pp_check(hyp1b_am_vintercept_student_sigmavinterceptonly) + xlim(c(-1, 1))
conditional_effects(hyp1b_am_vintercept_student_sigmavinterceptonly)

# fit student varying intercept model sigmavintercept
hyp1b_am_vintercept_student_sigmavintercept <- 
    brm(bf(
        diff_am ~ type + effsize_f + group + (1|session),
        sigma ~ group + (1|session)),
        iter = 10000, warmup = 1000,
        family = student(), 
        data = data_w |> 
            filter(group != "eg_benchmark"),
...
plot(hyp1b_am_vintercept_student_sigmavintercept)
pp_check(hyp1b_am_vintercept_student_sigmavintercept) + xlim(c(-1, 1))
conditional_effects(hyp1b_am_vintercept_student_sigmavintercept)
...
modelsummary(
    list("hyp1b_am_vinterceptonly_gaussian" = hyp1b_am_vinterceptonly_gaussian,
         ...
         "hyp1b_am_vintercept_student_sigmavinterceptonly" = hyp1b_am_vintercept_student_sigmavinterceptonly,
         "hyp1b_am_vintercept_student_sigmavintercept" = hyp1b_am_vintercept_student_sigmavintercept),
    estimate = "{estimate} [{conf.low}, {conf.high}]"
    )
...
hyp1b_am_noise_bf <- 
  bayes_factor(hyp1b_am_vintercept_student_sigmavintercept,
               hyp1b_am_vintercept_student_sigmavinterceptonly)
hyp1b_am_noise_bf
```
...
hyp1b_ov_vintercept_student <- 
    brm(diff_ov_filtered ~ type + effsize_f + group + (1|session),
        family = student(), 
        data = data_w |> 
            filter(group != "eg_benchmark"),
        save_pars = save_pars(all=TRUE))
...
# fit student varying intercept sigmavinterceptonly
hyp1b_ov_vintercept_student_sigmavinterceptonly <- 
    brm(bf(diff_ov_filtered ~ type + effsize_f + group + (1|session),
           sigma ~ + (1|session)),
        family = student(), 
        data = data_w |> 
            filter(group != "eg_benchmark"),
...
plot(hyp1b_ov_vintercept_student_sigmavinterceptonly)
pp_check(hyp1b_ov_vintercept_student_sigmavinterceptonly) + xlim(c(-1, 1))
conditional_effects(hyp1b_ov_vintercept_student_sigmavinterceptonly)

# fit student varying intercept sigmavintercept
hyp1b_ov_vintercept_student_sigmavintercept <- 
    brm(bf(diff_ov_filtered ~ type + effsize_f + group + (1|session),
           sigma ~ group + (1|session)),
        family = student(), 
        data = data_w |> 
...
plot(hyp1b_ov_vintercept_student_sigmavintercept)
pp_check(hyp1b_ov_vintercept_student_sigmavintercept) + xlim(c(-1, 1))
conditional_effects(hyp1b_ov_vintercept_student_sigmavintercept)
...
hyp1b_ov_noise_bf <- 
  bayes_factor(hyp1b_ov_vintercept_student_sigmavintercept,
               hyp1b_ov_vintercept_student_sigmavinterceptonly)
hyp1b_ov_noise_bf
```
...
hyp1b_u3_vintercept_student <- 
    brm(diff_u3_filtered ~ type + effsize_f + group + (1|session),
        family = student(), 
        data = data_w |> 
            filter(group != "eg_benchmark"),
        save_pars = save_pars(all=TRUE))
...
# fit student varying intercept sigmainterceptonly
hyp1b_u3_vintercept_student_sigmainterceptonly <- 
    brm(bf(diff_u3_filtered ~ type + effsize_f + group + (1|session),
           sigma ~ + (1|session)),
        family = student(), 
        data = data_w |> 
            filter(group != "eg_benchmark"),
...
plot(hyp1b_u3_vintercept_student_sigmainterceptonly)
pp_check(hyp1b_u3_vintercept_student_sigmainterceptonly) + xlim(c(-1, 1))
conditional_effects(hyp1b_u3_vintercept_student_sigmainterceptonly)


# fit student varying intercept sigmaintercept
hyp1b_u3_vintercept_student_sigmaintercept <- 
    brm(bf(diff_u3_filtered ~ type + effsize_f + group + (1|session),
           sigma ~ group + (1|session)),
        family = student(), 
        data = data_w |> 
...
plot(hyp1b_u3_vintercept_student_sigmaintercept)
pp_check(hyp1b_u3_vintercept_student_sigmaintercept) + xlim(c(-1, 1))
conditional_effects(hyp1b_u3_vintercept_student_sigmaintercept)
...
hyp1b_u3_bias_bf
hyp1b_u3_noise_bf <- 
    bayes_factor(hyp1b_u3_vintercept_student_sigmaintercept,
                 hyp1b_u3_vintercept_student_sigmainterceptonly)
hyp1b_u3_noise_bf
```
...
hyp3b_vintercept <-
    brm(diffi ~ type + effsize_f + group + (1 | session),
        data = data_w |>
            filter(group != "eg_benchmark"),
        save_pars = save_pars(all = TRUE)
    )
...
hyp5b_vintercept <-
    brm(infor ~ type + effsize_f + group + (1 | session),
        iter = 10000,
        data = data_w |>
            filter(group != "eg_benchmark"),
        save_pars = save_pars(all = TRUE)
...
hyp6b_vintercept <-
    brm(value ~ type + effsize_f + group + (1 | session),
        iter = 10000,
        data = data_w |>
            filter(group != "eg_benchmark"),
        save_pars = save_pars(all = TRUE)
...
hyp1a_am_noise_bf$bf

hyp1a_am_bias_bf$bf

hyp1a_ov_noise_bf$bf

hyp1a_ov_bias_bf$bf

hyp1a_u3_noise_bf$bf
...
hyp1b_am_noise_bf$bf
hyp1b_am_bias_bf$bf
hyp1b_ov_noise_bf$bf
hyp1b_ov_bias_bf$bf
hyp1b_u3_noise_bf$bf
hyp1b_u3_bias_bf$bf

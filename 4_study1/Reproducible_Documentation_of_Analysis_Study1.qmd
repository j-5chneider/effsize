...
#  geom_pointinterval() +
  stat_halfeye() +
  scale_x_continuous(name="Accuracy in U3 Metrics"#, #limits=c(-0.6, 0.6)
                     ) +
    theme_ipsum_rc()
...
#  geom_pointinterval() +
  stat_halfeye() +
  scale_x_continuous(name="Accuracy in Overlap Metrics"#, #limits=c(-0.6, 0.6)
                     ) +
    theme_ipsum_rc()
...
#  geom_pointinterval() +
  stat_halfeye() +
  scale_x_continuous(name="Perceived Task Difficulty"#, limits=c(-0.6, 0.6)
                     ) +
    theme_ipsum_rc()
...
#  geom_pointinterval() +
  stat_halfeye()+
  scale_x_continuous(name="Perceived Informativity"#, limits=c(-0.6, 0.6)
                     ) +
    theme_ipsum_rc()
...
#  geom_pointinterval() +
  stat_halfeye() +
  scale_x_continuous(name="Perceived Value "#, limits=c(-0.6, 0.6)
                     ) +
    theme_ipsum_rc()
...
mod_diffi_raincloud_halfeye_x <- 
    brm(scale(diffi) ~ dummy_raincloud_halfeye_x + effsize + (1|session), 
                          data = raincloud_vs_halfeye_x,
                          iter = 10000,
                          save_pars = save_pars(all = TRUE))

mod_infor_raincloud_halfeye_x <- 
    brm(scale(infor) ~ dummy_raincloud_halfeye_x + effsize + (1|session), 
                          data = raincloud_vs_halfeye_x,
                          iter = 10000,
                          save_pars = save_pars(all = TRUE))

mod_value_raincloud_halfeye_x <- 
    brm(scale(value) ~ dummy_raincloud_halfeye_x + effsize + (1|session), 
                          data = raincloud_vs_halfeye_x,
                          iter = 10000,
                          save_pars = save_pars(all = TRUE))
...
mod_diffi_raincloud_halfeye_y <- 
    brm(scale(diffi) ~ dummy_raincloud_halfeye_y + effsize + (1|session), 
                          data = raincloud_vs_halfeye_y,
                          iter = 10000,
                          save_pars = save_pars(all = TRUE))

mod_infor_raincloud_halfeye_y <- 
    brm(scale(infor) ~ dummy_raincloud_halfeye_y + effsize + (1|session), 
                          data = raincloud_vs_halfeye_y,
                          iter = 10000,
                          save_pars = save_pars(all = TRUE))

mod_value_raincloud_halfeye_y <- 
    brm(scale(value) ~ dummy_raincloud_halfeye_y + effsize + (1|session), 
                          data = raincloud_vs_halfeye_y,
                          iter = 10000,
                          save_pars = save_pars(all = TRUE))

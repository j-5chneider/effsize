...
study1_w <- full_join(plot_info, item_values, 
    ...
    dplyr::select(-values) %>%
    dplyr::mutate(rating_cl = as.numeric(acccl), # some var need to be defined 
                  rating_u3 = as.numeric(accu3), # as numeric again
                  ...
                  effsize_u3 = 100-pnorm(effsize), # reverse so that it fits the direction of the U3 item
...
sjPlot::tab_model(mod_effic01_gardneraltman_halfeye_x, mod_effic0306_gardneraltman_halfeye_x)

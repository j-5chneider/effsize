...
study1_w <- full_join(plot_info, item_values, 
    ...
    dplyr::select(-values) %>%
    dplyr::mutate(rating_cl = as.numeric(acccl), # some var need to be defined as numeric again
                  rating_u3 = 100-as.numeric(accu3), # reverse so that it fits the direction of the effect size

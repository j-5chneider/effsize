...
mean(study1_w$infor)
mean(study1_w$value)
mean(study1_w$rating_u3, na.rm=TRUE)
sd(study1_w$rating_u3, na.rm=TRUE)
mean(study1_w$rating_ov, na.rm=TRUE)
sd(study1_w$rating_ov, na.rm=TRUE)
mean(study1_w$rating_cl, na.rm=TRUE)
sd(study1_w$rating_cl, na.rm=TRUE)

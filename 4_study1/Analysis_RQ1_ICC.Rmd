...
BF_accov <- BF(mod_accov) # inconclusive
summary(BF_accov)
...
BF_accu3 <- BF(mod_accu3) # inconclusive
summary(BF_accu3)
...
BF_diffi <- BF(mod_diffi) # evidence in favor of a ICC >0 
summary(BF_diffi)

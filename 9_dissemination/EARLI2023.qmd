...
date: "26 Aug 2023" #last-modified # today
...
::: {.notes}
* Projekt __emerged__ as part of a __clearinghouse__.<br /><br />
* Clearinghouses __one__ approach to enable __evidence-informed__ practice<br />`r fa(name = "arrow-right")` by __providing__ teachers or teacher educators with evidence base from __synthesized research__.<br /><br />
...
* alternative metrics (e.g. Cohen's $U_3$)
  - perceived as more informative compared to $d$. <br />[@hanelmehler.2019]
  - Perceived as less informative compared to translations [@lortie-forguesetal.2021]
  - produce possible misconceptions <br /><span class="citation">(Schmidt et al., in press)</span><br /><br /><br />
...
::: {.notes}
* Evidence: is __challenging__ for teachers:
    - Cohen's d & percentile gain (WWC): little __information value__
* Translations: transport undesirable characteristics<br />`r fa(name = "arrow-right")` e.g., poorly comparable across age levels
* ...
* Advantage:
    - specific statistical information grasped __very quickly__ and __accurately__
...
<div class="flowchart2c">__perceived practical relevance__<br /><br /><br /></div>
:::
::::
...
::: {.notes}
* How do we conceptualize visualizations that are __accessible__ and teacher-oriented ?
* We look at __3 aspects__ that are relevant in a __framework of science communication__
:::
...
- Accuracy  
- Sensitivity</div>
<div class="flowchart2c">__perceived practical relevance__  
...
In terms of perceived practical relevance, we look at:
...
::: {.column width="30%"}
 <div class="blueTop">__Study 1__</div>
  <div class="blueBottom"><br />Comparison of the effect of different __visualization types__ on sense-making<br /><br />_exploratory_</div>
:::

::: {.column width="30%"}
 <div class="blueTop">__Study 2__</div>
  <div class="blueBottom"><br />Comparison of the effect of different __enrichment__ options on sense-making<br /><br />_confirmatory_</div>
:::
...
::: {.notes}
* we then asked the experts to __rate__ and __rank__ the visualization types
...
::: {.column width="30%"}
 <div class="blueTop">__Study 1__</div>
  <div class="blueBottom"><br />Comparison of the effect of different __visualization types__ on senst-making<br /><br />_exploratory_</div>
:::
...
* Sensitivity: `r fa(name = "thumbs-up", fill = "#B4CF66", height = "1.3em")` 
...
* __Not stand-alone__: context clearinghouses and teacher education/training<br /><br /><br />
* Limitation: Not (yet) compared to __textual__ representations
...
```{r}
study1_w %>% 
    dplyr::select(diff_am, diff_u3_filtered, diff_ov_filtered, session, type) %>% 

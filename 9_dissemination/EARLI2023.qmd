...
::: {.notes}
* for the Delphi studies, we surveyed 4 experts in data visualization<br />`r fa(name = "arrow-right")` __which visualization types__ they felt were appropriate for communicating __group scores on a metric variable__ to teachers.<br />
* __synthesis__ of the lists yielded 16 visualization types.<br />
...
::: {.notes}
* in study 1 we investigated the __effect of these visualizations__ on our __3 aspects of sense-making__.
...
__Bayesian multilevel__ analysis: dummy-coded visualization types  

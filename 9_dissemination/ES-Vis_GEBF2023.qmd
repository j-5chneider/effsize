...
format: 
  revealjs:
      ...
      footer: "Folien: [bit.ly/gebf23-v](https://bit.ly/gebf23-v) (view) | [bit.ly/gebf23-d](bit.ly/gebf23-d) (download)"
      smaller: true
      scrollable: true
      width: 1500
      height: 850
...
* "__Clearinghaus__" Ansätze<br />`r fa(name = "arrow-right")` Evidenzbasis systematischer Forschung bereitstellen [@knogleretal.2022]<br /><br /><br /><br />
* Effektstärken (ES) als eine der __Schlüsselinformationen__ [@burnsetal.2011]<br /><br /><br /><br />
* Wissenschaftler und "Clearinghäusern" verwenden in der Regel standardisierte __textuelle__ ES-Metriken [@cohen.1988]
:::
...
* Alternative Metriken (z. B. Cohen's $U_3$) werden als weniger informativ wahrgenommen oder produzieren Fehlkonzepte [@lortie-forguesetal.2021, Schmidt et al., under review]<br /><br /><br />
...
* **4 Experten** der Datenvisualisierung, **4 Experten** der Wissenschaftskommunikation in Clearinghäusern & Transfer
...
*Open Data & Open Code: [github.com/j-5chneider/effsize_public](https://github.com/j-5chneider/effsize_public)*
...
* nicht alleinstehend: Kontext Clearinghäuser und Aus-/Fortbildung von Lehrpersonen

...
* Alternative Metriken (z. B. Cohen's $U_3$) werden als weniger informativ wahrgenommen oder produzieren Fehlkonzepte [@lortie-forguesetal.2021, Schmidt et al., under review]
...
Link zu Open Data & Open Code

## Study 1 | plot types: Results
...
* Registered Report:
  ...
  + `r fa(name = "square-check")` stage 1 report

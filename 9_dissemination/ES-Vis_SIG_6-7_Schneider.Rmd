...
* Meta-analyses = highest level of evidence<br />`r fa(name = "arrow-right")` ES = __key information__ to be communicated [@burnsetal.2011]

</div>

<div class="notes">
* "__clearing house__" approaches<br />`r fa(name = "arrow-right")` “best available [...] evidence from systematic research”
* particularly evaluated according to the extent to which it allows to assess __treatment effectiveness__, i.e. the investigation of whether a treatment works
...
accurately estimating statistical information: __plot type__ plays a role
...
accurate estimation of statistical information needed for the evaluation of ES: Plot type plays a role
...
2. <span style="background-color:#f5f5f5;">Which plot types produce the __highest scores__ in the outcomes?</span> 
...
4. <span style="background-color:#d4d4d4;">How do plots with __cues__ affect the outcomes compared to plots without cues and a control group?</span>
...
* __Pilot study__ completed<br /><br /><br /><br />
* __Piloting__ of self-generated __measures__<br /><br /><br /><br />
* Writing stage 1 __Registered Report__

...
* textual representations of effect sizes are __challenging__ for teachers' perception and understanding [@haneletal.2019; @lortie-forguesetal.2021]<br /><br /><br />
...
1. Does __visualization type__ affect the outcomes in assessing effect sizes?  
...
1. Does __visualization type__ affect the outcomes in assessing effect sizes?  
2. Which visualization types produce the __highest ratings__ in A, B, C?  
3. How do visualizations with __visual benchmarks__ affect the outcomes, compared to visualizations without benchmarks?  
4. How do visualizations with __textual cues__ affect the outcomes compared to visualizations without textual cues and a control group?
...
1. Does __visualization type__ affect the outcomes in assessing effect sizes?<br />`r fa(name = "arrow-right")`testing intraclass correlations  against 0<br /><br /><br />

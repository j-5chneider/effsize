...
<div style="position: absolute; bottom: 2%; left: 5%; background-color:#d4d4d4; font-size: .7em; padding: 5px">
...
* benchmarks (anchoring) [@cohen.1988; ]
* cues [@schneideretal.2018]
...
* ... is the estimate of the size of the effect correct?
